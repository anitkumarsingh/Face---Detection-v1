...
const Footer = () =>{
     return(
      <footer className="pv4 ph3 tc">
        <a className="link near-black hover-silver dib mh3 tc" 
        ...
        <a className="link hover-silver near-black dib mh3 tc" 
        href="/" title="Slack">
          <svg className="dib h2 w2" fill="currentColor" 
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd" 
          clipRule="evenodd" strokeLinejoin="round" 
          strokeMiterlimit="1.414"><g fillRule="nonzero">
        ...
        <a className="link hover-silver near-black dib mh3 tc" 
        href="https://www.linkedin.com/in/anit-kumar" title="LinkedIn">
          <svg className="dib h2 w2" fill="currentColor" 
