...
const Footer = () =>{
     return(
        ...
        <a className="link dim gray dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" href="https://github.com/anitkumarsingh" title="">
        ...
        <p className="f4 white">Anit Kumar </p>
      </footer>
