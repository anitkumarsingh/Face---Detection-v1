...
const Footer = () =>{
     return(
      <footer class="pv4 ph3 tc">
        <a class="link near-black hover-silver dib mh3 tc" 
         href="https://github.com/anitkumarsingh" title="GitHub">
          <svg class="dib h2 w2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" 
          viewBox="0 0 16 16" fill-rule="evenodd" 
        ...
        <a class="link hover-silver near-black dib mh3 tc"
         href="/" title="Stack Overflow">
          <svg class="dib h2 w2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" 
        ...
        href="/" title="Slack">
          ...
          clip-rule="evenodd" stroke-linejoin="round" 
          stroke-miterlimit="1.414"><g fill-rule="nonzero">
        ...
        <a class="link hover-silver near-black dib mh3 tc" href="https://www.linkedin.com/in/anit-kumar" title="LinkedIn">
        ...
        <p className="f4 w5 grow  footer-text" style={{display:'block' , marginLeft:'40%'}}>Anit Kumar @ 2018</p>
      </footer>
     );
}
